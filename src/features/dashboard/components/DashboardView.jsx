...
export default function DashboardView({ state, setActiveTab }) {
  ...
  return (
    <div className="space-y-3 max-w-full animate-fade-in pb-12">
      ...
      {apiError && (
        <div className="bg-red-50/80 border border-red-200 p-3 rounded-lg text-red-950 animate-slide-down shadow-xs">
          <div className="flex items-start gap-2.5">
            ...
            <div className="space-y-1.5 flex-1">
              ...
              <p className="text-[10px] text-red-800 leading-normal font-mono bg-red-100/50 p-1.5 rounded border border-red-200/50">
                {apiError.message}
              </p>
                  ...
                  return (
                    <div key={idx} className="p-2.5 flex items-center justify-between hover:bg-muted/40 transition-colors">
                      ...
                      <div className="flex items-center gap-4 shrink-0 text-right">
                        ...
                        <div>
                          <p className="font-mono font-bold text-emerald-750 text-[11px]">₹{netVal.toLocaleString('en-IN')}</p>
